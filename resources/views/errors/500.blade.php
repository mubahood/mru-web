...
<title>Something went wrong | Muteesa I Royal University</title>
<style>
  *{box-sizing:border-box;}
  ...
  .icon{width:52px;height:52px;margin:0 auto 16px;background:#f7f0df;color:#7d6228;
    display:flex;align-items:center;justify-content:center;font-size:22px;border-radius:50%;font-weight:700;}
