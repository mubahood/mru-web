...
class UniversityContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Settings::set('university.hero_slides', json_encode([
            ...
            [
                'image' => 'university/hero/hero-engineering',
                'alt' => 'Students and a lecturer testing a paper structural model on a workbench at Muteesa I Royal University',
                'eyebrow' => 'Science, Technology, Engineering, Art & Design',
                'title' => 'Learning by building it',
                'text' => 'Engineering and design here are taught with your hands on the work — models tested to failure, circuits wired, systems built and measured.',
                'primary' => ['label' => 'Our faculties', 'route' => 'faculties.index'],
                'secondary' => ['label' => 'Explore programmes', 'route' => 'programmes.index'],
            ],
            [
                'image' => 'university/hero/hero-agriculture',
                'alt' => 'Two members of staff looking over a herd of long-horned Ankole cattle grazing on the university farm',
                'eyebrow' => 'Agriculture & the Land',
                'title' => 'A classroom with the gate open',
                'text' => 'The farm, the shade-net house and the process laboratory are teaching spaces — where agriculture is studied on the ground it is practised on.',
                'primary' => ['label' => 'Our faculties', 'route' => 'faculties.index'],
                'secondary' => ['label' => 'MRU Scholar', 'route' => 'scholar.home'],
            ],
            [
